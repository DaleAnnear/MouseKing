'''
Created on 13 sept. 2017 @author: Fab
Edited on 14 jan. 2025 @editor: Dale
'''

import os
import sys

LMT_path = os.path.abspath( os.path.join( os.path.dirname(__file__), '..' ) )
SQL_path = sys.argv[1]
sys.path.append(LMT_path)
